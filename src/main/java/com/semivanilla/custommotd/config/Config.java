...
public class Config {
    ...
    public static String cannotSetTimeOnDefault = "You cannot set a expire time on the default motd.";
    ...
    public static String MOTDSetTime = "Set expiry time for motd <name> to <seconds> seconds. (<date>)";
